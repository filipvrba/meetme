...
export default class ElmChatMessenger extends HTMLElement {
  ...
  constructor() {
    ...
    this._containerMessenger = this.querySelector("#containerMessenger");
    this._containerGreeting = this.querySelector("#containerGreeting");
  ...
  updateInitElm(id, sudo=false) {
    ...
    return this._cDatabase.getAvatarsWithMessages(this._id, (data) => {
      this._containerGreeting.classList.remove("container-greeting");
      this._containerGreeting.classList.add("messenger-display");
